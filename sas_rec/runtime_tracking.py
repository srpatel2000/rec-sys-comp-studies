"""Wall-clock timing for SASRec pipeline components (CSV under trained_models/time_tracking/sasrec/)."""
...
class SASRecRuntimeTracker:
    ...
    def save(self, trained_models_dir: Path) -> Path:
        """Write CSV to trained_models/time_tracking/sasrec/."""

        out_dir = Path(trained_models_dir) / "time_tracking" / "sasrec"
        out_dir.mkdir(parents=True, exist_ok=True)
        out_path = out_dir / f"sasrec_runtime_{self.data_type}_{self.run_id}.csv"
